...
project_id = 11623  # Example of a project ID: 12053

# The details (filename & path) to save the metadata
metadata_file_json = "Metadata_PlanktoScope_ToTS_SKQ_2023_UV_Experiment(unclean_complete).json"
metadata_file_csv = "Metadata_PlanktoScope_ToTS_SKQ_2023_UV_Experiment(unclean_complete).csv"
metadata_path = f"./Data/{metadata_file_json}" #Webscraping
...
payload = {
    ...
    "window_size": 100  # Number of results we want to fetch in one go: only window_size lines
}
